...
import { CheckSquare, Copy, Download, Loader2, RefreshCw, Square } from "lucide-react";
        ...
        <div className="flex flex-wrap gap-1">
          {TABS.map((t) => {
            const count =
              t.id === "all"
                ? assets.length
                : assets.filter((a) => a.kind === t.id).length;
              ...
              >
                ...
                >
                  {picked ? (
                    ...
                    <Square className="h-3 w-3 opacity-0 transition-opacity group-hover:opacity-100" />
                  )}
                </button>
